...
void    ft_add_address(int counter, zab **list, zab new)
{
    zab *temp;
    int i;

    i = 0;
    temp = malloc(sizeof(zab) * (counter + 2));
...
zab *add_to_list(void *ptr, int line, char *file, int type)
{
    static int  counter = 0;
    static zab  *list = NULL;
    zab         new;
